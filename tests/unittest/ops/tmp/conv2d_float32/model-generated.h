...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
     ...
     params_[2].shape_ptrs = {ParamDim(4, 4, &input_0_dim_0), ParamDim(28, 28, &output_0_dim_1), ParamDim(28, 28, &output_0_dim_2), ParamDim(256, 256, &output_0_dim_3)};
...
if (output_0 == nullptr) {
    ...
    conv2d_0(
        ...
        ss << "\"" << "conv2d_0" << "\": { \"ms_per_iter\": "
           ...
           << ", \"input_sizes\": " << "[[\"4\", \"28\", \"28\", \"128\"], [\"256\", \"3\", \"3\", \"128\"]]"
