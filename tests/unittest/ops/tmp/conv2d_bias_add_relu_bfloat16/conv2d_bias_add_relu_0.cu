...
using f7de63d7392b0aee95c9eaf9b5770eaa922e5396c = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_bf16_s16816fprop_optimized_bf16_64x64_32x10_nhwc_single_group_align8_base>;
  ...
  *out_ch = CO;
  ...
  if (NI == 4 && HI == 28 && WI == 28 && CI == 128) {
    ...
    typename f7de63d7392b0aee95c9eaf9b5770eaa922e5396c::Arguments arguments{
        ...
        {static_cast<cutlass::bfloat16_t*>(res_ptr), layout_C},                                 // TensorRefC const & ref_C
        ...
        static_cast<cutlass::bfloat16_t*>(bias_ptr),                                            // void * ptr_Vector
