...
void invoke_fused_elementwise_5(void* output0,void* output1, const void* input0,   int64_t n_elements, cudaStream_t stream);
...
void invoke_fused_elementwise_7(void* output0, const void* input0,const void* input1,   int64_t n_elements, cudaStream_t stream);
...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    softmax_2_0 = reinterpret_cast<decltype(softmax_2_0)>(blob_ptr + 0);
    softmax_3_0 = reinterpret_cast<decltype(softmax_3_0)>(blob_ptr + 409600);
    
         params_[0].shape_ptrs = {ParamDim(32, 32, &input_x_dim_0), ParamDim(64, 64, &input_x_dim_1), ParamDim(100, 100, &input_x_dim_2)};
     params_[1].shape_ptrs = {ParamDim(32, 32, &input_x_dim_0), ParamDim(64, 64, &input_x_dim_1), ParamDim(100, 100, &input_x_dim_2)};
...
if (output == nullptr) {
    ...
    {
        int64_t fused_elementwise_5_n_elements = 32 * 64 * 100;
        invoke_fused_elementwise_5(elementwise_0_0,elementwise_1_0, input_x,   fused_elementwise_5_n_elements, stream);
    }
    ...
    {
        int64_t fused_elementwise_7_n_elements = 32 * 64 * 100;
        invoke_fused_elementwise_7(output, softmax_2_0,softmax_3_0,   fused_elementwise_7_n_elements, stream);
    }
