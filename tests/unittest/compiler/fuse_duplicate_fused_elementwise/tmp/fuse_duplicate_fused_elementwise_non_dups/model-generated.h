...
void invoke_fused_elementwise_9(void* output0, const void* input0,   int64_t n_elements, cudaStream_t stream);
    

void softmax_3(void* input,
               void* output,
               int multiprocessor_count,
               cudaStream_t stream);
    

void invoke_fused_elementwise_11(void* output0, const void* input0,const void* input1,const void* input2,   int64_t n_elements, cudaStream_t stream);
...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
        elementwise_0_0 = reinterpret_cast<decltype(elementwise_0_0)>(blob_ptr + 409600);
    elementwise_1_0 = reinterpret_cast<decltype(elementwise_1_0)>(blob_ptr + 819200);
    elementwise_2_0 = reinterpret_cast<decltype(elementwise_2_0)>(blob_ptr + 1228800);
    softmax_3_0 = reinterpret_cast<decltype(softmax_3_0)>(blob_ptr + 0);
    softmax_4_0 = reinterpret_cast<decltype(softmax_4_0)>(blob_ptr + 409600);
    softmax_5_0 = reinterpret_cast<decltype(softmax_5_0)>(blob_ptr + 819200);
    
         params_[0].shape_ptrs = {ParamDim(32, 32, &input_x_dim_0), ParamDim(64, 64, &input_x_dim_1), ParamDim(100, 100, &input_x_dim_2)};
     params_[1].shape_ptrs = {ParamDim(32, 32, &input_z_dim_0), ParamDim(64, 64, &input_z_dim_1), ParamDim(100, 100, &input_z_dim_2)};
     params_[2].shape_ptrs = {ParamDim(32, 32, &input_x_dim_0), ParamDim(64, 64, &input_x_dim_1), ParamDim(100, 100, &input_x_dim_2)};
...
if (input_x == nullptr) {
    throw std::runtime_error("Constant input_x was not set! Set the value with set_constant.");
     ...
     input_z = static_cast<decltype(input_z)>(params_[1].ptr);

if (input_z == nullptr) {
    throw std::runtime_error("Constant input_z was not set! Set the value with set_constant.");
}
    
     output = static_cast<decltype(output)>(params_[2].ptr);
...
if (output == nullptr) {
    ...
    {
        int64_t fused_elementwise_8_n_elements = 32 * 64 * 100;
        invoke_fused_elementwise_8(elementwise_0_0, input_x,   fused_elementwise_8_n_elements, stream);
    }
    ...
    {
        int64_t fused_elementwise_9_n_elements = 32 * 64 * 100;
        invoke_fused_elementwise_9(elementwise_1_0, input_x,   fused_elementwise_9_n_elements, stream);
    }
    ...
    {
        int64_t fused_elementwise_9_n_elements = 32 * 64 * 100;
        invoke_fused_elementwise_9(elementwise_2_0, input_z,   fused_elementwise_9_n_elements, stream);
    }
    ...
    {
        int64_t fused_elementwise_11_n_elements = 32 * 64 * 100;
        invoke_fused_elementwise_11(output, softmax_3_0,softmax_4_0,softmax_5_0,   fused_elementwise_11_n_elements, stream);
    }
            ...
            
    {
      ...
      {
        std::cout << "Profiling: " << "softmax_3" << " (" << iters << " iterations)" << std::endl;
        std::vector<std::pair<EventType, EventType>> call_events(iters);
        for (auto& [call_start, call_end] : call_events) {
          CreateEvent(&call_start);
          CreateEvent(&call_end);
    ...
    softmax_3(
      ...
      {
        std::cout << "Profiling: " << "fused_elementwise_11" << " (" << iters << " iterations)" << std::endl;
        std::vector<std::pair<EventType, EventType>> call_events(iters);
        for (auto& [call_start, call_end] : call_events) {
          CreateEvent(&call_start);
          CreateEvent(&call_end);
            ...
            
    {
        ...
        ss << "\"" << "fused_elementwise_11" << "\": { \"ms_per_iter\": "
           << std::setprecision(4) << (milliseconds/iters)
           << ", \"qps\": " << 1000 * iters / milliseconds
           << ", \"input_sizes\": " << "[[\"32\", \"64\", \"100\"], [\"32\", \"64\", \"100\"], [\"32\", \"64\", \"100\"]]"
           << ", \"output_sizes\": " << "[[\"32\", \"64\", \"100\"]]"
  ...
  private:
   ...
   void* elementwise_1_0 {nullptr};
   void* elementwise_2_0 {nullptr};
   void* softmax_3_0 {nullptr};
