...
using f5ca0fdd1560ccf565dade50cce2a32d429ff256d = Operation_cutlass_tensorop_s1688tf32gemm_64x64_16x10_tt_align4;
...
void perm102_bmm_rrr_bias_13 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 4 && M >= 256 && M <= 512 && N == 32 && K == 64) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f5ca0fdd1560ccf565dade50cce2a32d429ff256d::ElementAccumulator;

    using coord_t = cutlass::gemm::GemmCoord::Index;
    typename f5ca0fdd1560ccf565dade50cce2a32d429ff256d::Arguments arguments;

    if constexpr (cutlass::gemm::detail::IsCutlass3GemmKernel<typename f5ca0fdd1560ccf565dade50cce2a32d429ff256d::GemmKernel>::value) {
    arguments = {
    ...
    f5ca0fdd1560ccf565dade50cce2a32d429ff256d gemm_op;
