...
using f41080c52c2ddbf20db2d8ab40d9c42b9990bc01e = Operation_cutlass_tensorop_s1688tf32gemm_64x64_32x5_tn_align4;
...
void perm102_bmm_rcr_bias_20 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 4 && M >= 128 && M <= 256 && N == 10 && K == 32) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f41080c52c2ddbf20db2d8ab40d9c42b9990bc01e::ElementAccumulator;

    using coord_t = cutlass::gemm::GemmCoord::Index;
    typename f41080c52c2ddbf20db2d8ab40d9c42b9990bc01e::Arguments arguments;

    if constexpr (cutlass::gemm::detail::IsCutlass3GemmKernel<typename f41080c52c2ddbf20db2d8ab40d9c42b9990bc01e::GemmKernel>::value) {
    arguments = {
    ...
    f41080c52c2ddbf20db2d8ab40d9c42b9990bc01e gemm_op;
