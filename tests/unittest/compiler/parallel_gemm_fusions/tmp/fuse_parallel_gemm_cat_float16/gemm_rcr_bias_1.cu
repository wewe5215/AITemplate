...
using fa7ec1172777ff0fb3c57b4f1b638d627228c5783 = Operation_cutlass_tensorop_f16_s16816gemm_f16_64x64_32x10_tn_align8;
...
void gemm_rcr_bias_1 (
 ...
 int64_t K = (*a_dim1);
  ...
  if (M >= 256 && M <= 512 && N == 128 && K == 64) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename fa7ec1172777ff0fb3c57b4f1b638d627228c5783::ElementAccumulator;

    using coord_t = cutlass::gemm::GemmCoord::Index;
    typename fa7ec1172777ff0fb3c57b4f1b638d627228c5783::Arguments arguments;

    if constexpr (cutlass::gemm::detail::IsCutlass3GemmKernel<typename fa7ec1172777ff0fb3c57b4f1b638d627228c5783::GemmKernel>::value) {
    arguments = {
    ...
    fa7ec1172777ff0fb3c57b4f1b638d627228c5783 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_1 specialization."
  );
}