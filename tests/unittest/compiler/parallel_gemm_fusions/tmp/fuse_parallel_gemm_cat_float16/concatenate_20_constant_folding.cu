...
void concatenate_20_constant_folding(
    void *output,
  ...
  for (int64_t i = 0; i < rank; i++) {
    ...
    for (int64_t j = 1; j < num_real_inputs; j++) {
      if (real_input_shapes[j][i] != dim) {
        throw std::runtime_error(
          "invalid input shape, func_name: concatenate_20_constant_folding, dim: " +
  ...
  if (!output) {
    ...
    TensorAccessor input_accessor4 = {
      0,
    ...
    TensorAccessor input_accessor5 = {
      0,
    ...
    TensorAccessor input_accessor6 = {
      0,
    ...
    TensorAccessor input_accessor7 = {
      0,
    ...
    TensorAccessor input_accessor8 = {
      0,
    ...
    TensorAccessor input_accessor9 = {
      0,
    ...
    TensorAccessor input_accessor10 = {
      0,
    ...
    TensorAccessor input_accessor11 = {
      0,
    ...
    TensorAccessor input_accessor12 = {
      0,
    ...
    TensorAccessor input_accessor13 = {
      0,
    ...
    TensorAccessor input_accessor14 = {
      0,
    ...
    TensorAccessor input_accessor15 = {
      0,
    ...
    const TensorAccessor *input_accessors[16] = {

      &input_accessor0, &input_accessor1, &input_accessor2, &input_accessor3, &input_accessor4, &input_accessor5, &input_accessor6, &input_accessor7, &input_accessor8, &input_accessor9, &input_accessor10, &input_accessor11, &input_accessor12, &input_accessor13, &input_accessor14, &input_accessor15
  ...
  using transform_type = NoopTransform<half>;
  
  
  invoke_concatenate_fast<half, half, 16, 2, transform_type>(
      real_input_shapes,
      inputs,
      input_accessors,
      local_output_shape,
      ...
      output,
      concat_dim,
      "concatenate_20_constant_folding",
      stream);
  return;
