...
#define CUTLASS_CHECK(status)                                                         \
  ...
  using Operation_cutlass_tensorop_f16_s16816gemm_f16_64x64_64x5_tt_align4 = cutlass::gemm::device::GemmUniversal<
...
using f9646e6157a1e7ee5b251a02162188f22c3010ae0 = Operation_cutlass_tensorop_f16_s16816gemm_f16_64x64_64x5_tt_align4;

void perm102_bmm_rrr_bias_21 (
    void* a_ptr,
    void* b_ptr,
    void* bias_ptr,
    void* c_ptr,
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 4 && M >= 256 && M <= 512 && N == 128 && K == 100) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f9646e6157a1e7ee5b251a02162188f22c3010ae0::ElementAccumulator;

    using coord_t = cutlass::gemm::GemmCoord::Index;
    typename f9646e6157a1e7ee5b251a02162188f22c3010ae0::Arguments arguments;

    if constexpr (cutlass::gemm::detail::IsCutlass3GemmKernel<typename f9646e6157a1e7ee5b251a02162188f22c3010ae0::GemmKernel>::value) {
    arguments = {
    ...
    f9646e6157a1e7ee5b251a02162188f22c3010ae0 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this perm102_bmm_rrr_bias_21 specialization."
  );
}