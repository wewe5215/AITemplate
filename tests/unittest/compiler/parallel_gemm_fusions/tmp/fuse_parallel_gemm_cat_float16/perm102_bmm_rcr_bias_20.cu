...
using fc59b2ece2a5d056d12f9846249da64229105413d = Operation_cutlass_tensorop_f16_s16816gemm_f16_64x64_32x10_tn_align8;

void perm102_bmm_rcr_bias_20 (
    void* a_ptr,
    void* b_ptr,
    void* bias_ptr,
    void* c_ptr,
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 4 && M >= 128 && M <= 256 && N == 100 && K == 32) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename fc59b2ece2a5d056d12f9846249da64229105413d::ElementAccumulator;

    using coord_t = cutlass::gemm::GemmCoord::Index;
    typename fc59b2ece2a5d056d12f9846249da64229105413d::Arguments arguments;

    if constexpr (cutlass::gemm::detail::IsCutlass3GemmKernel<typename fc59b2ece2a5d056d12f9846249da64229105413d::GemmKernel>::value) {
    arguments = {
    ...
    fc59b2ece2a5d056d12f9846249da64229105413d gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this perm102_bmm_rcr_bias_20 specialization."
  );
}