...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
        split_0_0 = reinterpret_cast<decltype(split_0_0)>(blob_ptr + 262144);
    split_0_1 = reinterpret_cast<decltype(split_0_1)>(blob_ptr + 393216);
    split_0_2 = reinterpret_cast<decltype(split_0_2)>(blob_ptr + 327680);
    split_0_3 = reinterpret_cast<decltype(split_0_3)>(blob_ptr + 458752);
...
if (output0 == nullptr) {
  ...
  
  {
    ...
    int64_t **output_shapes[] = {
      split_0_0_shape, split_0_2_shape, split_0_1_shape, split_0_3_shape
    };
