...
using f48cfad5a8dfdf3bba48e0d7647fcd4ce2ab2e6fd = Operation_cutlass_tensorop_f16_s16816gemm_f16_128x128_32x4_tn_align8;
...
void gemm_rcr_bias_11 (
 ...
 int64_t K = (*a_dim1);
  ...
  if (M == 1024 && N == 672 && K == 256) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f48cfad5a8dfdf3bba48e0d7647fcd4ce2ab2e6fd::ElementAccumulator;

    using coord_t = cutlass::gemm::GemmCoord::Index;
    typename f48cfad5a8dfdf3bba48e0d7647fcd4ce2ab2e6fd::Arguments arguments;

    if constexpr (cutlass::gemm::detail::IsCutlass3GemmKernel<typename f48cfad5a8dfdf3bba48e0d7647fcd4ce2ab2e6fd::GemmKernel>::value) {
    arguments = {
    ...
    f48cfad5a8dfdf3bba48e0d7647fcd4ce2ab2e6fd gemm_op;
