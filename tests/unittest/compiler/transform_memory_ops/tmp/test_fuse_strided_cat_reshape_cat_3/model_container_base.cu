...
ModelContainerBase::ModelContainerBase(
    ...
    : constants_size_(params_size),
     ...
     max_param_shapes_[0] = {1024, 1, 2};
     max_param_shapes_[1] = {1024, 4};
     max_param_shapes_[2] = {1024, 4};
     max_param_shapes_[3] = {1024, 4};
     max_param_shapes_[4] = {1024, 12};
     max_param_shapes_[5] = {1024, 4, 2};
     max_param_shapes_[6] = {1024};
...
ModelContainer* CreateModelContainer(size_t num_runtimes, AITemplateAllocator& allocator) {
  ...
  return new ModelContainer(num_runtimes, 6, 1, 0, 0, 0, allocator);
}
} // namespace ait