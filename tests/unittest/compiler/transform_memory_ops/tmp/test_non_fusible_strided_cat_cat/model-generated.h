...
void invoke_fused_elementwise_3(void* output0, const void* input0,const void* input1, int64_t batch_0,   int64_t n_elements, cudaStream_t stream);
...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
        concatenate_0_0 = reinterpret_cast<decltype(concatenate_0_0)>(blob_ptr + 131072);
    
         params_[0].shape_ptrs = {ParamDim(1, 1024, &batch_0), ParamDim(2, 2, &x0_dim_1), ParamDim(8, 8, &x0_dim_2)};
     params_[1].shape_ptrs = {ParamDim(1, 1024, &batch_0), ParamDim(2, 2, &x1_dim_1), ParamDim(8, 8, &x1_dim_2)};
     params_[2].shape_ptrs = {ParamDim(1, 1024, &batch_0), ParamDim(4, 4, &x2_dim_1), ParamDim(8, 8, &x2_dim_2)};
     params_[3].shape_ptrs = {ParamDim(1, 1024, &batch_0), ParamDim(8, 8, &output0_dim_1), ParamDim(8, 8, &x0_dim_2)};
...
if (output0 == nullptr) {
  ...
  
  {
    ...
    int64_t *concatenate_0_0_shape[] = {
      &batch_0, &concatenate_0_0_dim_1, &x0_dim_2
    };
  ...
  
  {
    ...
    const void *inputs[] = {
      ...
      int64_t concatenate_0_0_shape_0[] = {
        batch_0, concatenate_0_0_dim_1, x0_dim_2
      };

    const int64_t *real_input_shapes[] = {
      concatenate_0_0_shape_0
    };
    ...
    const int64_t *all_input_shapes[] = {
      concatenate_0_0_shape_0, orig_elementwise_1_0_shape
    };

    int64_t *output0_shape[] = {
      &batch_0, &output0_dim_1, &x0_dim_2
    };

    int64_t concat_dim_sizes[] = {
      concatenate_0_0_dim_1, 4
    };
    ...
    {
        int64_t fused_elementwise_3_n_elements = batch_0 * 4 * 8;
        invoke_fused_elementwise_3(output0, concatenate_0_0,x2, batch_0,   fused_elementwise_3_n_elements, stream);
    }
            ...
            
  {
    ...
    concatenate_0(
        ...
        ss << "\"" << "concatenate_0" << "\": { \"ms_per_iter\": "
           ...
           << ", \"input_sizes\": " << "[[\"batch_0\", \"2\", \"8\"], [\"batch_0\", \"2\", \"8\"]]"
           << ", \"output_sizes\": " << "[[\"batch_0\", \"4\", \"8\"]]"
            ...
            
  {
            ...
            
    {
        ...
        ss << "\"" << "fused_elementwise_3" << "\": { \"ms_per_iter\": "
           << std::setprecision(4) << (milliseconds/iters)
           << ", \"qps\": " << 1000 * iters / milliseconds
           << ", \"input_sizes\": " << "[[\"batch_0\", \"4\", \"8\"], [\"batch_0\", \"4\", \"8\"]]"
           << ", \"output_sizes\": " << "[[\"batch_0\", \"4\", \"8\"]]"
  ...
  private:
   ...
   int64_t x2_dim_1 { 4 };
   int64_t x2_dim_2 { 8 };
   int64_t concatenate_0_0_dim_1 { 4 };
   int64_t output0_dim_1 { 8 };
