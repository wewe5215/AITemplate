...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
        concatenate_0_0 = reinterpret_cast<decltype(concatenate_0_0)>(blob_ptr + 37191680);
     ...
     params_[4].shape_ptrs = {ParamDim(1024, 1024, &input0_dim_0), ParamDim(10, 10, &concatenate_0_0_dim_1), ParamDim(260, 260, &output0_dim_2)};
     params_[5].shape_ptrs = {ParamDim(1024, 1024, &input3_dim_0), ParamDim(10, 10, &input3_dim_1), ParamDim(648, 648, &output1_dim_2)};
...
if (output0 == nullptr) {
    throw std::runtime_error("Constant output0 was not set! Set the value with set_constant.");
     ...
     output1 = static_cast<decltype(output1)>(params_[5].ptr);
...
if (output1 == nullptr) {
  ...
  
  {
    ...
    const void *inputs[] = {
      ...
      int64_t input2_shape_1[] = {
        input2_dim_0, input2_dim_1, input2_dim_2
      };

    const int64_t *real_input_shapes[] = {
      concatenate_0_0_shape_0, input2_shape_1
    };
    ...
    int64_t *output0_shape[] = {
      &input0_dim_0, &concatenate_0_0_dim_1, &output0_dim_2
    };

    int64_t concat_dim_sizes[] = {
      input0_dim_2, input2_dim_2
    };
  ...
  
  {
    ...
    const int64_t *real_input_shapes[] = {
      input3_shape_0, output0_shape_1, input2_shape_2
    };
    ...
    int64_t *output1_shape[] = {
      &input3_dim_0, &input3_dim_1, &output1_dim_2
    };

    int64_t concat_dim_sizes[] = {
      input3_dim_2, output0_dim_2, input2_dim_2
    };
            ...
            
  {
    ...
    concatenate_1(
        ...
        ss << "\"" << "concatenate_1" << "\": { \"ms_per_iter\": "
           << std::setprecision(4) << (milliseconds/iters)
           << ", \"qps\": " << 1000 * iters / milliseconds
           << ", \"input_sizes\": " << "[[\"1024\", \"10\", \"128\"], [\"1024\", \"10\", \"132\"]]"
           << ", \"output_sizes\": " << "[[\"1024\", \"10\", \"260\"]]"
            ...
            
  {
    ...
    concatenate_3(
        ...
        ss << "\"" << "concatenate_3" << "\": { \"ms_per_iter\": "
           << std::setprecision(4) << (milliseconds/iters)
           << ", \"qps\": " << 1000 * iters / milliseconds
           << ", \"input_sizes\": " << "[[\"1024\", \"10\", \"256\"], [\"1024\", \"10\", \"260\"], [\"1024\", \"10\", \"132\"]]"
  ...
  private:
   ...
   int64_t output0_dim_2 { 260 };
   int64_t output1_dim_2 { 648 };
