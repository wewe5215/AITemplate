...
ModelContainerBase::ModelContainerBase(
    ...
    : constants_size_(params_size),
     ...
     param_names_[3] = "input3";
     param_names_[4] = "output0";
     param_names_[5] = "output1";
     ...
     max_param_shapes_[0] = {1024, 5, 128};
     max_param_shapes_[1] = {1024, 5, 128};
     max_param_shapes_[2] = {1024, 10, 132};
     max_param_shapes_[3] = {1024, 10, 256};
     max_param_shapes_[4] = {1024, 10, 260};
     max_param_shapes_[5] = {1024, 10, 648};
...
ModelContainer* CreateModelContainer(size_t num_runtimes, AITemplateAllocator& allocator) {
  ...
  return new ModelContainer(num_runtimes, 4, 2, 0, 0, 0, allocator);
}
} // namespace ait