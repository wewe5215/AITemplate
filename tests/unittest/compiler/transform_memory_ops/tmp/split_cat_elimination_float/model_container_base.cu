...
ModelContainerBase::ModelContainerBase(
    ...
    : constants_size_(params_size),
     ...
     param_names_[4] = "output1";
     param_names_[3] = "output0";
     ...
     max_param_shapes_[0] = {1024, 10, 128};
     max_param_shapes_[1] = {1024, 10, 128};
     max_param_shapes_[2] = {1024, 10, 128};
     max_param_shapes_[4] = {1024, 30, 128};
     max_param_shapes_[3] = {1024, 20, 64};
...
ModelContainer* CreateModelContainer(size_t num_runtimes, AITemplateAllocator& allocator) {
  ...
  return new ModelContainer(num_runtimes, 3, 2, 0, 0, 0, allocator);
}
} // namespace ait