...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
     ...
     params_[2].shape_ptrs = {ParamDim(1024, 1024, &input0_dim_0), ParamDim(20, 20, &output1_dim_1), ParamDim(128, 128, &concatenate_1_0_dim_2)};
...
if (output1 == nullptr) {
  ...
  
  {
    ...
    const int64_t *real_input_shapes[] = {
      output0_shape_0, output0_shape_1
    };
    ...
    int64_t *output1_shape[] = {
      &input0_dim_0, &output1_dim_1, &concatenate_1_0_dim_2
    };
