...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
        split_2_0 = reinterpret_cast<decltype(split_2_0)>(blob_ptr + 5242880);
    split_2_1 = reinterpret_cast<decltype(split_2_1)>(blob_ptr + 6553600);
    
         params_[0].shape_ptrs = {ParamDim(1024, 1024, &input0_dim_0), ParamDim(10, 10, &input0_dim_1), ParamDim(128, 128, &input0_dim_2)};
     params_[1].shape_ptrs = {ParamDim(1024, 1024, &input0_dim_0), ParamDim(10, 10, &output0_dim_1), ParamDim(128, 128, &input0_dim_2)};
     params_[2].shape_ptrs = {ParamDim(1024, 1024, &input0_dim_0), ParamDim(20, 20, &output1_dim_1), ParamDim(64, 64, &split_2_0_dim_2)};
...
if (output1 == nullptr) {
  ...
  
  {
    ...
    int64_t *output0_shape[] = {
      &input0_dim_0, &output0_dim_1, &input0_dim_2
    };
  ...
  
  {
    ...
    void *outputs[] = {
      ...
      int64_t *split_2_0_shape[] = {
        &input0_dim_0, &output0_dim_1, &split_2_0_dim_2
      };
      int64_t *split_2_1_shape[] = {
        &input0_dim_0, &output0_dim_1, &split_2_1_dim_2
      };

    int64_t **output_shapes[] = {
      split_2_0_shape, split_2_1_shape
    };
  ...
  
  {
    ...
    const void *inputs[] = {
      ...
      int64_t split_2_0_shape_0[] = {
        input0_dim_0, output0_dim_1, split_2_0_dim_2
      };
      int64_t split_2_1_shape_1[] = {
        input0_dim_0, output0_dim_1, split_2_1_dim_2
      };

    const int64_t *real_input_shapes[] = {
      split_2_0_shape_0, split_2_1_shape_1
    };
    ...
    int64_t *output1_shape[] = {
      &input0_dim_0, &output1_dim_1, &split_2_0_dim_2
    };

    int64_t concat_dim_sizes[] = {
      output0_dim_1, output0_dim_1
    };
            ...
            
  {
    ...
    concatenate_1(
      ...
      {
        std::cout << "Profiling: " << "split_2" << " (" << iters << " iterations)" << std::endl;
        std::vector<std::pair<EventType, EventType>> call_events(iters);
        for (auto& [call_start, call_end] : call_events) {
          CreateEvent(&call_start);
          CreateEvent(&call_end);
  ...
  private:
   ...
   void* split_2_0 {nullptr};
   void* split_2_1 {nullptr};
   void* output1 {nullptr};
   int64_t input0_dim_0 { 1024 };
   int64_t input0_dim_1 { 10 };
   int64_t input0_dim_2 { 128 };
   int64_t output0_dim_1 { 10 };
   int64_t split_2_0_dim_2 { 64 };
   int64_t split_2_1_dim_2 { 64 };
   int64_t output1_dim_1 { 20 };
