...
using f674a38c6e1382181c8d7a20df0a03baed7af9d53 = Operation_cutlass_tensorop_f16_s16816gemm_f16_64x64_32x10_tt_align8;
...
void perm102_bmm_rrr_bias_61 (
 ...
 int64_t K = (*a_dim2);
  ...
  int64_t output_offset = 768; // default to 0
  ...
  if (B == 2 && M == 256 && N == 128 && K == 72) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f674a38c6e1382181c8d7a20df0a03baed7af9d53::ElementAccumulator;

    using coord_t = cutlass::gemm::GemmCoord::Index;
    typename f674a38c6e1382181c8d7a20df0a03baed7af9d53::Arguments arguments;

    if constexpr (cutlass::gemm::detail::IsCutlass3GemmKernel<typename f674a38c6e1382181c8d7a20df0a03baed7af9d53::GemmKernel>::value) {
    arguments = {
    ...
    f674a38c6e1382181c8d7a20df0a03baed7af9d53 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this perm102_bmm_rrr_bias_61 specialization."
  );
}