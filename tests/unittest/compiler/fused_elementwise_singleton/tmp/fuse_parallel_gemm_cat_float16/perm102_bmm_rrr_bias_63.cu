...
#define CUTLASS_CHECK(status)                                                         \
  ...
  using Operation_cutlass_tensorop_f16_s16816gemm_f16_64x64_32x10_tt_align2 = cutlass::gemm::device::GemmUniversal<
...
using fdbaa7fa5e8300f79ce3422419b7320ee10a4e5d5 = Operation_cutlass_tensorop_f16_s16816gemm_f16_64x64_32x10_tt_align2;

void perm102_bmm_rrr_bias_63 (
    void* a_ptr,
    void* b_ptr,
    void* bias_ptr,
    void* c_ptr,
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 16 && M >= 15 && M <= 31 && N == 8 && K == 6) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename fdbaa7fa5e8300f79ce3422419b7320ee10a4e5d5::ElementAccumulator;

    using coord_t = cutlass::gemm::GemmCoord::Index;
    typename fdbaa7fa5e8300f79ce3422419b7320ee10a4e5d5::Arguments arguments;

    if constexpr (cutlass::gemm::detail::IsCutlass3GemmKernel<typename fdbaa7fa5e8300f79ce3422419b7320ee10a4e5d5::GemmKernel>::value) {
    arguments = {
    ...
    fdbaa7fa5e8300f79ce3422419b7320ee10a4e5d5 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this perm102_bmm_rrr_bias_63 specialization."
  );
}