...
using fb8b446fc77f092a819b1693a47dd5cac44742625 = Operation_cutlass_tensorop_f16_s16816gemm_f16_128x64_32x6_tt_align8;

void perm102_bmm_rrr_bias_13 (
    void* a_ptr,
    void* b_ptr,
    void* bias_ptr,
    void* c_ptr,
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 4 && M >= 256 && M <= 512 && N == 128 && K == 64) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename fb8b446fc77f092a819b1693a47dd5cac44742625::ElementAccumulator;

    using coord_t = cutlass::gemm::GemmCoord::Index;
    typename fb8b446fc77f092a819b1693a47dd5cac44742625::Arguments arguments;

    if constexpr (cutlass::gemm::detail::IsCutlass3GemmKernel<typename fb8b446fc77f092a819b1693a47dd5cac44742625::GemmKernel>::value) {
    arguments = {
    ...
    fb8b446fc77f092a819b1693a47dd5cac44742625 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this perm102_bmm_rrr_bias_13 specialization."
  );
}