...
using f0172aa18304dbd2e5781691cbc3a4ded5b71198d = Operation_cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tn_align8;

void perm102_bmm_rcr_bias_24 (
    void* a_ptr,
    void* b_ptr,
    void* bias_ptr,
    void* c_ptr,
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 16 && M >= 1024 && M <= 2048 && N == 100 && K == 128) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f0172aa18304dbd2e5781691cbc3a4ded5b71198d::ElementAccumulator;

    using coord_t = cutlass::gemm::GemmCoord::Index;
    typename f0172aa18304dbd2e5781691cbc3a4ded5b71198d::Arguments arguments;

    if constexpr (cutlass::gemm::detail::IsCutlass3GemmKernel<typename f0172aa18304dbd2e5781691cbc3a4ded5b71198d::GemmKernel>::value) {
    arguments = {
    ...
    f0172aa18304dbd2e5781691cbc3a4ded5b71198d gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this perm102_bmm_rcr_bias_24 specialization."
  );
}