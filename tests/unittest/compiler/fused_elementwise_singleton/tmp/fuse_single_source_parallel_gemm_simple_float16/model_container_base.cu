...
constexpr std::array<ConstantInfo, 3> owned_constants = {
  ConstantInfo{"W0", 0, 0, 131072},ConstantInfo{"W1", 131072, 131072, 16384},ConstantInfo{"W2", 147456, 147456, 65536}
};
} // namespace
...
ModelContainerBase::ModelContainerBase(
    ...
    : constants_size_(params_size),
     ...
     bound_constant_size_[0] = 131072;
     bound_constant_size_[1] = 16384;
     bound_constant_size_[2] = 65536;
     max_param_shapes_[0] = {1024, 256};
     max_param_shapes_[1] = {1024, 256};
     max_param_shapes_[3] = {1024, 128};
     max_param_shapes_[2] = {1024, 32};
  for (size_t i = 0; i < num_params_; ++i) {
    ...
    constant_folding_outputs_offsets_.resize(1);
         constant_folding_outputs_offsets_[0] = 212992;
    

    bound_constant_offsets_.resize(3);
         bound_constant_offsets_[0] = 0;
     bound_constant_offsets_[1] = 131072;
     bound_constant_offsets_[2] = 147456;
...
ModelContainer* CreateModelContainer(size_t num_runtimes, AITemplateAllocator& allocator) {
  ...
  return new ModelContainer(num_runtimes, 1, 3, 3, 0, 425984, allocator);
}
} // namespace ait