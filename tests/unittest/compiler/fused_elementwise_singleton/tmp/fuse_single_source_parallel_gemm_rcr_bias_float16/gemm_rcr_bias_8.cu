...
using fb5bac1dd8d2738374cc9f838952c7d0740726a5c = Operation_cutlass_tensorop_f16_s16816gemm_f16_64x64_64x5_tn_align8;
...
void gemm_rcr_bias_8 (
 ...
 int64_t K = (*a_dim1);
  ...
  if (M == 1024 && N == 316 && K == 256) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename fb5bac1dd8d2738374cc9f838952c7d0740726a5c::ElementAccumulator;

    using coord_t = cutlass::gemm::GemmCoord::Index;
    typename fb5bac1dd8d2738374cc9f838952c7d0740726a5c::Arguments arguments;

    if constexpr (cutlass::gemm::detail::IsCutlass3GemmKernel<typename fb5bac1dd8d2738374cc9f838952c7d0740726a5c::GemmKernel>::value) {
    arguments = {
    ...
    fb5bac1dd8d2738374cc9f838952c7d0740726a5c gemm_op;
