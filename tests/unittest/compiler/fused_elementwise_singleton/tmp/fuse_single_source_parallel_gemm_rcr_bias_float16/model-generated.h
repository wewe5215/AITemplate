...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
        concatenate_6_0 = reinterpret_cast<decltype(concatenate_6_0)>(constants + 162496);
    concatenate_7_0 = reinterpret_cast<decltype(concatenate_7_0)>(constants + 324288);
    gemm_rcr_bias_8_0 = reinterpret_cast<decltype(gemm_rcr_bias_8_0)>(blob_ptr + 0);
    split_9_0 = reinterpret_cast<decltype(split_9_0)>(blob_ptr + 647168);
    elementwise_10_0 = reinterpret_cast<decltype(elementwise_10_0)>(blob_ptr + 1695744);
    elementwise_11_0 = reinterpret_cast<decltype(elementwise_11_0)>(blob_ptr + 1843200);
    
         params_[0].shape_ptrs = {ParamDim(1024, 1024, &X_dim_0), ParamDim(256, 256, &X_dim_1)};
     params_[3].shape_ptrs = {ParamDim(1024, 1024, &X_dim_0), ParamDim(256, 256, &W2_dim_0)};
     params_[1].shape_ptrs = {ParamDim(1024, 1024, &X_dim_0), ParamDim(36, 36, &W0_dim_0)};
     params_[2].shape_ptrs = {ParamDim(1024, 1024, &X_dim_0), ParamDim(24, 24, &W1_dim_0)};
...
if (output1 == nullptr) {
  ...
  
  {
    ...
    void *outputs[] = {
      ...
      int64_t *elementwise_11_0_shape[] = {
        &X_dim_0, &elementwise_11_0_dim_1
      };
      int64_t *split_9_0_shape[] = {
        &X_dim_0, &split_9_0_dim_1
      };

    int64_t **output_shapes[] = {
      elementwise_10_0_shape, elementwise_11_0_shape, split_9_0_shape
    };

    const int64_t gemm_rcr_bias_8_0_shape[] = {
  ...
  
    {
        ...
        invoke_fused_elementwise_0(output2, split_9_0,   fused_elementwise_0_n_elements, stream);
    }
    ...
    {
        int64_t fused_elementwise_1_n_elements = 1024 * 36;
        invoke_fused_elementwise_1(output0, elementwise_10_0,   fused_elementwise_1_n_elements, stream);
    }
    ...
    {
        int64_t fused_elementwise_2_n_elements = 1024 * 24;
        invoke_fused_elementwise_2(output1, elementwise_11_0,   fused_elementwise_2_n_elements, stream);
    }
    ...
    gemm_rcr_bias_8(
        ...
        ss << "\"" << "gemm_rcr_bias_8" << "\": { \"ms_per_iter\": "
           ...
           << ", \"input_sizes\": " << "[[\"1024\", \"256\"], [\"316\", \"256\"], [\"316\"]]"
           << ", \"output_sizes\": " << "[[\"1024\", \"316\"]]"
      ...
      {
        std::cout << "Profiling: " << "split_9" << " (" << iters << " iterations)" << std::endl;
        std::vector<std::pair<EventType, EventType>> call_events(iters);
        for (auto& [call_start, call_end] : call_events) {
          CreateEvent(&call_start);
          CreateEvent(&call_end);
            ...
            
  {
    ...
    split_9(
        ...
        ss << "\"" << "split_9" << "\": { \"ms_per_iter\": "
           << std::setprecision(4) << (milliseconds/iters)
           << ", \"qps\": " << 1000 * iters / milliseconds
           << ", \"input_sizes\": " << "[[\"1024\", \"316\"]]"
           << ", \"output_sizes\": " << "[[\"1024\", \"36\"], [\"1024\", \"24\"], [\"1024\", \"256\"]]"
        
          << ", \"split_sizes\": " << "\"[36, 24, 256]]\""
  ...
  private:
   ...
   void* gemm_rcr_bias_8_0 {nullptr};
   void* split_9_0 {nullptr};
   void* output2 {nullptr};
   void* elementwise_10_0 {nullptr};
   void* output0 {nullptr};
   void* elementwise_11_0 {nullptr};
   ...
   int64_t split_9_0_dim_1 { 256 };
   int64_t elementwise_10_0_dim_1 { 36 };
   int64_t elementwise_11_0_dim_1 { 24 };
