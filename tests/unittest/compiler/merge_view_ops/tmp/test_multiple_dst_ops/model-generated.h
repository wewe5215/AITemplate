...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
     ...
     params_[1].shape_ptrs = {ParamDim(8, 8, &reshape_0_0_dim_0)};
...
if (y0 == nullptr) {
    ...
    {
      const int64_t reshape_0_0_shape[] = {
    ...
    void ProfileImpl(StreamType stream, size_t iters, const std::string& filename) {
      ...
      {
        std::cout << "Profiling: " << "reshape_0" << " (" << iters << " iterations)" << std::endl;
