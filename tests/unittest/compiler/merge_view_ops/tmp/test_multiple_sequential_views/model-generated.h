...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
     ...
     params_[1].shape_ptrs = {ParamDim(8, 8, &reshape_2_0_dim_0), ParamDim(2, 2, &reshape_2_0_dim_2), ParamDim(4, 4, &reshape_2_0_dim_3)};
...
if (y == nullptr) {
    ...
    {
      int64_t shape[] = { reshape_2_0_dim_0,reshape_2_0_dim_1,reshape_2_0_dim_2,reshape_2_0_dim_3 };
      reduce_sum_3(
          y,
          reshape_4_0,
          1,
    ...
    void ProfileImpl(StreamType stream, size_t iters, const std::string& filename) {
      ...
      {
        std::cout << "Profiling: " << "reshape_4" << " (" << iters << " iterations)" << std::endl;
  ...
  private:
   ...
   int64_t x0_dim_1 { 4 };
   int64_t x0_dim_2 { 8 };
   int64_t reshape_2_0_dim_0 { 8 };
   int64_t reshape_2_0_dim_1 { 1 };
   int64_t reshape_2_0_dim_2 { 2 };
   int64_t reshape_2_0_dim_3 { 4 };
