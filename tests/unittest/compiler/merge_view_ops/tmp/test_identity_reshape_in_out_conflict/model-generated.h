...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
     ...
     params_[1].shape_ptrs = {ParamDim(2, 2, &y_dim_0), ParamDim(4, 4, &y_dim_1), ParamDim(8, 8, &y_dim_2)};
...
if (params_[1].ptr == nullptr) {
  ...
  DEVICE_CHECK(DeviceToDeviceCopy(params_[1].ptr, x0, 1*2*4*8 * 4, stream));
    }
