...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
        bmm_rcr_tensor = reinterpret_cast<decltype(bmm_rcr_tensor)>(blob_ptr + 2560);
    
         params_[0].shape_ptrs = {ParamDim(10, 10, &input_0_dim_0), ParamDim(8, 16, &input_0_dim_1), ParamDim(8, 8, &input_0_dim_2)};
     params_[1].shape_ptrs = {ParamDim(10, 10, &input_1_dim_0), ParamDim(1, 1, &input_1_dim_1), ParamDim(8, 8, &input_1_dim_2)};
     params_[2].shape_ptrs = {ParamDim(10, 10, &input_0_dim_0), ParamDim(8, 16, &input_0_dim_1), ParamDim(1, 1, &input_1_dim_1)};
...
if (output_0 == nullptr) {
    ...
    {
        int64_t fused_elementwise_3_n_elements = 10 * input_0_dim_1 * 1;
        invoke_fused_elementwise_3(output_0, bmm_rcr_tensor, input_0_dim_1,   fused_elementwise_3_n_elements, stream);
    }
    ...
    bmm_rcr_n1_4(
        ...
        ss << "\"" << "bmm_rcr_n1_4" << "\": { \"ms_per_iter\": "
           ...
           << ", \"input_sizes\": " << "[[\"10\", \"input_0_dim_1\", \"8\"], [\"10\", \"1\", \"8\"]]"
           << ", \"output_sizes\": " << "[[\"10\", \"input_0_dim_1\", \"1\"]]"
            ...
            
    {
        ...
        ss << "\"" << "fused_elementwise_3" << "\": { \"ms_per_iter\": "
           << std::setprecision(4) << (milliseconds/iters)
           << ", \"qps\": " << 1000 * iters / milliseconds
           << ", \"input_sizes\": " << "[[\"10\", \"input_0_dim_1\", \"1\"]]"
           << ", \"output_sizes\": " << "[[\"10\", \"input_0_dim_1\", \"1\"]]"
  ...
  private:
   ...
   int64_t input_0_dim_0 { 10 };
   int64_t input_0_dim_1 { 0 };
   int64_t input_0_dim_2 { 8 };
   int64_t input_1_dim_0 { 10 };
