...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
         ...
         params_[0].shape_ptrs = {ParamDim(8, 8, &input_0_dim_0), ParamDim(8, 8, &input_0_dim_1), ParamDim(8, 8, &input_0_dim_2)};
     params_[1].shape_ptrs = {ParamDim(8, 8, &input_1_dim_0), ParamDim(8, 8, &input_1_dim_1), ParamDim(8, 8, &input_1_dim_2)};
     params_[2].shape_ptrs = {ParamDim(8, 8, &input_0_dim_0), ParamDim(8, 8, &input_0_dim_1), ParamDim(8, 8, &input_1_dim_1)};
...
if (input_1 == nullptr) {
    throw std::runtime_error("Constant input_1 was not set! Set the value with set_constant.");
     ...
     bmm_rcr_tensor = static_cast<decltype(bmm_rcr_tensor)>(params_[2].ptr);

if (bmm_rcr_tensor == nullptr) {
    throw std::runtime_error("Constant bmm_rcr_tensor was not set! Set the value with set_constant.");
}
    ...
    void ProfileImpl(StreamType stream, size_t iters, const std::string& filename) {
      ...
      {
        std::cout << "Profiling: " << "bmm_rcr_0" << " (" << iters << " iterations)" << std::endl;
