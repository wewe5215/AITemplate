...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
         ...
         params_[0].shape_ptrs = {ParamDim(100, 200, &input_0_dim_0), ParamDim(3, 3, &input_0_dim_1)};
     params_[1].shape_ptrs = {ParamDim(3, 3, &input_1_dim_0), ParamDim(6, 6, &input_1_dim_1)};
     params_[3].shape_ptrs = {ParamDim(100, 200, &input_0_dim_0), ParamDim(6, 6, &input_1_dim_1)};
     params_[2].shape_ptrs = {ParamDim(100, 200, &input_0_dim_0), ParamDim(6, 6, &input_1_dim_1)};
...
if (output_0 == nullptr) {
    ...
    gemm_rrr_small_nk_3(
        ...
        ss << "\"" << "gemm_rrr_small_nk_3" << "\": { \"ms_per_iter\": "
           ...
           << ", \"input_sizes\": " << "[[\"input_0_dim_0\", \"3\"], [\"3\", \"6\"]]"
