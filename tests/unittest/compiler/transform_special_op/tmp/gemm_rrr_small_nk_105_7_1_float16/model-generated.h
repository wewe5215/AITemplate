...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
         ...
         params_[0].shape_ptrs = {ParamDim(105, 105, &input_0_dim_0), ParamDim(1, 1, &input_0_dim_1)};
     params_[1].shape_ptrs = {ParamDim(1, 1, &input_1_dim_0), ParamDim(7, 7, &input_1_dim_1)};
     params_[3].shape_ptrs = {ParamDim(105, 105, &input_0_dim_0), ParamDim(7, 7, &input_1_dim_1)};
     params_[2].shape_ptrs = {ParamDim(105, 105, &input_0_dim_0), ParamDim(7, 7, &input_1_dim_1)};
...
if (output_0 == nullptr) {
    ...
    {
        int64_t fused_elementwise_2_n_elements = 105 * 7;
  ...
  private:
   ...
   int64_t input_0_dim_0 { 105 };
   int64_t input_0_dim_1 { 1 };
