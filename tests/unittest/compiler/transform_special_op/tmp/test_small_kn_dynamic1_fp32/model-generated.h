...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
         ...
         params_[0].shape_ptrs = {ParamDim(10, 50, &input_0_dim_0), ParamDim(4, 4, &input_0_dim_1)};
     params_[1].shape_ptrs = {ParamDim(4, 4, &input_1_dim_0), ParamDim(6, 6, &input_1_dim_1)};
     params_[3].shape_ptrs = {ParamDim(10, 50, &input_0_dim_0), ParamDim(6, 6, &input_1_dim_1)};
     params_[2].shape_ptrs = {ParamDim(10, 50, &input_0_dim_0), ParamDim(6, 6, &input_1_dim_1)};
