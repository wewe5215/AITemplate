...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
        bmm_rcr_tensor = reinterpret_cast<decltype(bmm_rcr_tensor)>(blob_ptr + 2880);
    
         params_[0].shape_ptrs = {ParamDim(10, 10, &input_0_dim_0), ParamDim(8, 8, &input_0_dim_1), ParamDim(8, 8, &input_0_dim_2)};
     params_[1].shape_ptrs = {ParamDim(10, 10, &input_1_dim_0), ParamDim(1, 1, &input_1_dim_1), ParamDim(8, 8, &input_1_dim_2)};
     params_[2].shape_ptrs = {ParamDim(10, 10, &input_0_dim_0), ParamDim(8, 8, &input_0_dim_1), ParamDim(1, 1, &input_1_dim_1)};
...
if (output_0 == nullptr) {
    ...
    {
        int64_t fused_elementwise_3_n_elements = 10 * 8 * 1;
