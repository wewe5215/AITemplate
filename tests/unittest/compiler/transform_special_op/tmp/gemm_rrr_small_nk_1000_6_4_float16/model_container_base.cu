...
ModelContainerBase::ModelContainerBase(
    ...
    : constants_size_(params_size),
     ...
     param_names_[3] = "gemm_rrr_tensor";
     ...
     max_param_shapes_[0] = {1000, 4};
     max_param_shapes_[1] = {4, 6};
     max_param_shapes_[3] = {1000, 6};
     max_param_shapes_[2] = {1000, 6};
...
ModelContainer* CreateModelContainer(size_t num_runtimes, AITemplateAllocator& allocator) {
  ...
  return new ModelContainer(num_runtimes, 2, 2, 0, 0, 0, allocator);
}
} // namespace ait