...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
     ...
     params_[1].shape_ptrs = {ParamDim(1, 10, &x_dim_0), ParamDim(1, 1, &x_dim_2), ParamDim(32, 32, &x_dim_1), ParamDim(51, 51, &x_dim_3)};
