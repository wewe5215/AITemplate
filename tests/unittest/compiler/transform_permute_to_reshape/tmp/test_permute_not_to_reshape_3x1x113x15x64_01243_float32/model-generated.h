...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
        permute021_0_0 = reinterpret_cast<decltype(permute021_0_0)>(blob_ptr + 1301760);
    
         params_[0].shape_ptrs = {ParamDim(3, 3, &x_dim_0), ParamDim(1, 1, &x_dim_1), ParamDim(113, 113, &x_dim_2), ParamDim(15, 15, &x_dim_3), ParamDim(64, 64, &x_dim_4)};
     params_[1].shape_ptrs = {ParamDim(3, 3, &x_dim_0), ParamDim(1, 1, &x_dim_1), ParamDim(113, 113, &x_dim_2), ParamDim(64, 64, &x_dim_4), ParamDim(15, 15, &x_dim_3)};
...
if (z == nullptr) {
    ...
    {
      const int64_t x_dims[] = {x_dim_0, x_dim_1, x_dim_2, x_dim_3, x_dim_4};
      permute021_0(
          x,
          permute021_0_0,
          5,
    ...
    void ProfileImpl(StreamType stream, size_t iters, const std::string& filename) {
      ...
      {
        std::cout << "Profiling: " << "permute021_0" << " (" << iters << " iterations)" << std::endl;
            ...
            
    {
      ...
      permute021_0(
        ...
        ss << "\"" << "permute021_0" << "\": { \"ms_per_iter\": "
           << std::setprecision(4) << (milliseconds/iters)
           << ", \"qps\": " << 1000 * iters / milliseconds
           << ", \"input_sizes\": " << "[[\"3\", \"1\", \"113\", \"15\", \"64\"]]"
           << ", \"output_sizes\": " << "[[\"3\", \"1\", \"113\", \"64\", \"15\"]]"
