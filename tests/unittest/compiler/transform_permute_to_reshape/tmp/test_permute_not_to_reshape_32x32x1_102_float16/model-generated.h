...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
        permute102_0_0 = reinterpret_cast<decltype(permute102_0_0)>(blob_ptr + 2048);
    
         params_[0].shape_ptrs = {ParamDim(32, 32, &x_dim_0), ParamDim(32, 32, &x_dim_1), ParamDim(1, 1, &x_dim_2)};
     params_[1].shape_ptrs = {ParamDim(32, 32, &x_dim_1), ParamDim(32, 32, &x_dim_0), ParamDim(1, 1, &x_dim_2)};
...
if (z == nullptr) {
    ...
    void ProfileImpl(StreamType stream, size_t iters, const std::string& filename) {
      ...
      {
        std::cout << "Profiling: " << "permute102_0" << " (" << iters << " iterations)" << std::endl;
