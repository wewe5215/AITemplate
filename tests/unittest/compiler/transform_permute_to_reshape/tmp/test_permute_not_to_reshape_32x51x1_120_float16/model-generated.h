...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
        permute_1_0 = reinterpret_cast<decltype(permute_1_0)>(blob_ptr + 3264);
    
         params_[0].shape_ptrs = {ParamDim(32, 32, &x_dim_0), ParamDim(51, 51, &x_dim_1)};
     params_[1].shape_ptrs = {ParamDim(51, 51, &x_dim_1), ParamDim(1, 1, &unsqueeze_0_0_dim_2), ParamDim(32, 32, &x_dim_0)};
  ...
  
{
    ...
    ait_unsqueeze_0(
      ...
      {
        std::cout << "Profiling: " << "permute_1" << " (" << iters << " iterations)" << std::endl;
        std::vector<std::pair<EventType, EventType>> call_events(iters);
        for (auto& [call_start, call_end] : call_events) {
          CreateEvent(&call_start);
          CreateEvent(&call_end);
            ...
            
{
    ...
    permute_1(
        ...
        ss << "\"" << "permute_1" << "\": { \"ms_per_iter\": "
           << std::setprecision(4) << (milliseconds/iters)
           << ", \"qps\": " << 1000 * iters / milliseconds
           << ", \"input_sizes\": " << "[[\"32\", \"51\", \"1\"]]"
           << ", \"output_sizes\": " << "[[\"51\", \"1\", \"32\"]]"
