...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
     ...
     params_[3].shape_ptrs = {ParamDim(1, 1, &batch_dim), ParamDim(28, 28, &output_0_dim_1), ParamDim(28, 28, &output_0_dim_2), ParamDim(256, 256, &output_0_dim_3)};
...
if (output_0 == nullptr) {
    ...
    void ProfileImpl(StreamType stream, size_t iters, const std::string& filename) {
      ...
      {
        std::cout << "Profiling: " << "conv2d_bias_sigmoid_2" << " (" << iters << " iterations)" << std::endl;
    ...
    conv2d_bias_sigmoid_2(
        ...
        ss << "\"" << "conv2d_bias_sigmoid_2" << "\": { \"ms_per_iter\": "
           << std::setprecision(4) << (milliseconds/iters)
           << ", \"qps\": " << 1000 * iters / milliseconds
           << ", \"input_sizes\": " << "[[\"1\", \"28\", \"28\", \"128\"], [\"256\", \"3\", \"3\", \"128\"], [\"256\"]]"
