...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
     ...
     params_[3].shape_ptrs = {ParamDim(1, 1, &batch_dim), ParamDim(28, 28, &input_3_dim_1), ParamDim(28, 28, &input_3_dim_2), ParamDim(256, 256, &input_3_dim_3)};
...
if (output_0 == nullptr) {
    ...
    void ProfileImpl(StreamType stream, size_t iters, const std::string& filename) {
      ...
      {
        std::cout << "Profiling: " << "conv2d_bias_add_relu_3" << " (" << iters << " iterations)" << std::endl;
    ...
    conv2d_bias_add_relu_3(
        ...
        ss << "\"" << "conv2d_bias_add_relu_3" << "\": { \"ms_per_iter\": "
