...
using fe73d48c45d4cdb0a76d09ac6d8faf4f0cd6b17f0 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_64x256_32x4_nhwc_align8_base>;


void transposed_conv2d_0 (
    void* in_ptr,
    void* weight_ptr,
    void* out_ptr,
  ...
  *out_ch = CO;
  ...
  if (NI == 1 && HI == 28 && WI == 28 && CI == 256) {
    
    using ElementComputeEpilogue = typename fe73d48c45d4cdb0a76d09ac6d8faf4f0cd6b17f0::ElementCompute;
    //  TODO: cast to right dtype
    typename fe73d48c45d4cdb0a76d09ac6d8faf4f0cd6b17f0::Arguments arguments{
        ...
        {static_cast<cutlass::half_t*>(out_ptr), layout_C},                                 // TensorRefC const & ref_C
    ...
    fe73d48c45d4cdb0a76d09ac6d8faf4f0cd6b17f0 conv_op;
