...
void conv2d_bias_add_identity_2(
  void*,
  void*,
  void*,
...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
     ...
     params_[3].shape_ptrs = {ParamDim(1, 1, &batch_dim), ParamDim(28, 28, &residual_dim_1), ParamDim(28, 28, &residual_dim_2), ParamDim(256, 256, &residual_dim_3)};
     params_[4].shape_ptrs = {ParamDim(1, 1, &batch_dim), ParamDim(28, 28, &output_0_dim_1), ParamDim(28, 28, &output_0_dim_2), ParamDim(256, 256, &output_0_dim_3)};
...
if (input_2 == nullptr) {
    throw std::runtime_error("Constant input_2 was not set! Set the value with set_constant.");
     ...
     residual = static_cast<decltype(residual)>(params_[3].ptr);

if (residual == nullptr) {
    throw std::runtime_error("Constant residual was not set! Set the value with set_constant.");
}
...
if (output_0 == nullptr) {
    ...
    void ProfileImpl(StreamType stream, size_t iters, const std::string& filename) {
      ...
      {
        std::cout << "Profiling: " << "conv2d_bias_add_identity_2" << " (" << iters << " iterations)" << std::endl;
    ...
    conv2d_bias_add_identity_2(
        ...
        ss << "\"" << "conv2d_bias_add_identity_2" << "\": { \"ms_per_iter\": "
           << std::setprecision(4) << (milliseconds/iters)
           << ", \"qps\": " << 1000 * iters / milliseconds
           << ", \"input_sizes\": " << "[[\"1\", \"28\", \"28\", \"128\"], [\"256\", \"3\", \"3\", \"128\"], [\"256\"], [\"1\", \"28\", \"28\", \"256\"]]"
  ...
  private:
   ...
   int64_t residual_dim_1 { 28 };
   int64_t residual_dim_2 { 28 };
   int64_t residual_dim_3 { 256 };
