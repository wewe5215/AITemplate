...
using f7878142feedddec1bb6e043b4a8d7f0fc365e8d0 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_64x256_32x4_nhwc_align8_base>;


void transposed_conv2d_bias_relu_2 (
    void* in_ptr,
    void* weight_ptr,
    void* out_ptr,
  ...
  *out_ch = CO;
  ...
  if (NI == 4 && HI == 14 && WI == 14 && CI == 256) {
    
    using ElementComputeEpilogue = typename f7878142feedddec1bb6e043b4a8d7f0fc365e8d0::ElementCompute;
    //  TODO: cast to right dtype
    typename f7878142feedddec1bb6e043b4a8d7f0fc365e8d0::Arguments arguments{
    ...
    f7878142feedddec1bb6e043b4a8d7f0fc365e8d0 conv_op;
