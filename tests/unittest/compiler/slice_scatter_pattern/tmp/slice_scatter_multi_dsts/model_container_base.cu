...
ModelContainerBase::ModelContainerBase(
    ...
    : constants_size_(params_size),
     ...
     max_param_shapes_[0] = {4, 3, 4};
     max_param_shapes_[1] = {3, 7, 10};
     max_param_shapes_[2] = {4, 3, 4};
     max_param_shapes_[4] = {4, 3, 4};
     max_param_shapes_[3] = {2, 3, 11};
