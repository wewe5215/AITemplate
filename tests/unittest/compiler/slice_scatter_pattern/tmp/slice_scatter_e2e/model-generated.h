...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
         ...
         params_[0].shape_ptrs = {ParamDim(2, 2, &input_0_dim_0), ParamDim(3, 3, &input_0_dim_1), ParamDim(5, 5, &input_0_dim_2)};
     params_[1].shape_ptrs = {ParamDim(3, 3, &input_1_dim_0), ParamDim(7, 7, &input_1_dim_1), ParamDim(10, 10, &input_1_dim_2)};
     params_[2].shape_ptrs = {ParamDim(2, 2, &dynamic_slice_1_0_dim_0), ParamDim(7, 7, &output_0_dim_1), ParamDim(4, 4, &dynamic_slice_1_0_dim_2)};
...
if (output_0 == nullptr) {
  ...
  
    {
      ...
      int64_t *output_0_shape[] = {
        &dynamic_slice_1_0_dim_0, &output_0_dim_1, &dynamic_slice_1_0_dim_2
      };
