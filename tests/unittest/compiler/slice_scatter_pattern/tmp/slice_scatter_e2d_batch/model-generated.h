...
class Model : public ModelBase<Model> {
  ...
  public:
    ...
    auto* blob_ptr = static_cast<uint8_t*>(blob_.get());
         ...
         params_[0].shape_ptrs = {ParamDim(4, 1024, &input_batch_0), ParamDim(3, 3, &input_0_dim_1)};
     params_[1].shape_ptrs = {ParamDim(4, 1024, &input_batch_1), ParamDim(3, 3, &input_1_dim_1)};
     params_[2].shape_ptrs = {ParamDim(2, 2, &output_0_dim_0), ParamDim(2, 2, &dynamic_slice_0_0_dim_1)};
...
if (output_0 == nullptr) {
  ...
  
    {
      ...
      int64_t *output_0_shape[] = {
        &output_0_dim_0, &dynamic_slice_0_0_dim_1
      };
      ...
      int64_t input_0_shape[] = {
        input_batch_0, input_0_dim_1
      };
      int64_t input_1_shape[] = {
        input_batch_1, input_1_dim_1
      };
    ...
    void ProfileImpl(StreamType stream, size_t iters, const std::string& filename) {
      ...
      {
        std::cout << "Profiling: " << "slice_scatter_3" << " (" << iters << " iterations)" << std::endl;
            ...
            
    {
      ...
      slice_scatter_3(
        ...
        ss << "\"" << "slice_scatter_3" << "\": { \"ms_per_iter\": "
           << std::setprecision(4) << (milliseconds/iters)
           << ", \"qps\": " << 1000 * iters / milliseconds
           << ", \"input_sizes\": " << "[[\"input_batch_0\", \"3\"], [\"input_batch_1\", \"3\"]]"
           << ", \"output_sizes\": " << "[[\"2\", \"2\"]]"
  ...
  private:
   ...
   int64_t input_batch_0 { 0 };
   int64_t input_0_dim_1 { 3 };
   int64_t input_batch_1 { 0 };
   int64_t input_1_dim_1 { 3 };
   int64_t output_0_dim_0 { 2 };
   int64_t dynamic_slice_0_0_dim_1 { 2 };
