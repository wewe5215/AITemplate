...
using ffcc6ea289dee75bc52bc107a963cff9d90da6f0c = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_h16816fprop_optimized_64x128_32x6_nhwc_single_group_align8_base>;
...
void conv2d_bias_relu_26 (
  ...
  *out_ch = CO;
  ...
  if (NI == 1 && HI == 28 && WI == 28 && CI == 512) {
    
    using ElementComputeEpilogue = typename ffcc6ea289dee75bc52bc107a963cff9d90da6f0c::ElementCompute;
    //  TODO: cast to right dtype
    typename ffcc6ea289dee75bc52bc107a963cff9d90da6f0c::Arguments arguments{
    ...
    ffcc6ea289dee75bc52bc107a963cff9d90da6f0c conv_op;
