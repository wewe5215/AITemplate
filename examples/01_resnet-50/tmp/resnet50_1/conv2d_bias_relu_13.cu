...
using f9bfcdd38c3a2ad2bc45608439573013de7d89ee4 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_h16816fprop_optimized_64x128_32x6_nhwc_single_group_align8_base>;
...
void conv2d_bias_relu_13 (
  ...
  *out_ch = CO;
  ...
  if (NI == 1 && HI == 56 && WI == 56 && CI == 256) {
    
    using ElementComputeEpilogue = typename f9bfcdd38c3a2ad2bc45608439573013de7d89ee4::ElementCompute;
    //  TODO: cast to right dtype
    typename f9bfcdd38c3a2ad2bc45608439573013de7d89ee4::Arguments arguments{
    ...
    f9bfcdd38c3a2ad2bc45608439573013de7d89ee4 conv_op;
