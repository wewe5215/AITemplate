...
using f3dcaf788a39e82f788b6ef679b4680b0aa00f0d6 = Operation_cutlass_tensorop_h16816gemm_64x64_64x5_tn_align8;
...
void gemm_rcr_bias_56 (
 ...
 int64_t M = (*a_dim0) * (*a_dim1) * (*a_dim2);
...
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f3dcaf788a39e82f788b6ef679b4680b0aa00f0d6::ElementAccumulator;

    using coord_t = cutlass::gemm::GemmCoord::Index;
    typename f3dcaf788a39e82f788b6ef679b4680b0aa00f0d6::Arguments arguments;

    if constexpr (cutlass::gemm::detail::IsCutlass3GemmKernel<typename f3dcaf788a39e82f788b6ef679b4680b0aa00f0d6::GemmKernel>::value) {
    arguments = {
    ...
    f3dcaf788a39e82f788b6ef679b4680b0aa00f0d6 gemm_op;
    ...
    return;
      ...
      std::cout << "input_ndims3: " << *a_dim3 << std::endl;
      ...
      std::cout << "output_ndims3: " << *c_dim3 << std::endl;
