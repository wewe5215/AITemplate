...
#define CUTLASS_CHECK(status)                                                         \
  ...
  // Conv2dFprop Fixed_channels kernel instance "cutlass_tensorop_h16816fprop_fixed_channels_64x64_32x3_nhwc_align4"
  using cutlass_tensorop_h16816fprop_fixed_channels_64x64_32x3_nhwc_align4_base = 
...
using f4fcada3ac85f38822b753512ddd9e96a802420c5 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_h16816fprop_fixed_channels_64x64_32x3_nhwc_align4_base>;
...
void conv2d_bias_relu_few_channels_1 (
  ...
  *out_ch = CO;
  ...
  if (NI == 1 && HI == 224 && WI == 224 && CI == 4) {
    ...
    f4fcada3ac85f38822b753512ddd9e96a802420c5 conv_op;
