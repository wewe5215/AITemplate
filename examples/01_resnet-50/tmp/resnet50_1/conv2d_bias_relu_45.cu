...
using f686ddf832ed7695db88c10a17e818c0f5bb14096 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_h16816fprop_optimized_64x64_32x10_nhwc_single_group_align8_base>;
...
void conv2d_bias_relu_45 (
  ...
  *out_ch = CO;
  ...
  if (NI == 1 && HI == 14 && WI == 14 && CI == 1024) {
    
    using ElementComputeEpilogue = typename f686ddf832ed7695db88c10a17e818c0f5bb14096::ElementCompute;
    //  TODO: cast to right dtype
    typename f686ddf832ed7695db88c10a17e818c0f5bb14096::Arguments arguments{
    ...
    f686ddf832ed7695db88c10a17e818c0f5bb14096 conv_op;
