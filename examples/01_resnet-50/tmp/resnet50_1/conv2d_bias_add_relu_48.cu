...
using fd6ca992747cefd33e7bb021f430e5c7e5db04299 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_h16816fprop_optimized_64x64_32x10_nhwc_single_group_align8_base>;
...
void conv2d_bias_add_relu_48 (
  ...
  *out_ch = CO;
  ...
  if (NI == 1 && HI == 7 && WI == 7 && CI == 512) {
    
    using ElementComputeEpilogue = typename fd6ca992747cefd33e7bb021f430e5c7e5db04299::ElementCompute;
    //  TODO: cast to right dtype
    typename fd6ca992747cefd33e7bb021f430e5c7e5db04299::Arguments arguments{
    ...
    fd6ca992747cefd33e7bb021f430e5c7e5db04299 conv_op;
