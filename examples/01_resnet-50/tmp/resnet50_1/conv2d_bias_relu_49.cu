...
using fe527c28457a9b7e570f819855bcf081128b02705 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_h16816fprop_optimized_64x64_32x10_nhwc_single_group_align8_base>;
...
void conv2d_bias_relu_49 (
  ...
  *out_ch = CO;
  ...
  if (NI == 1 && HI == 7 && WI == 7 && CI == 2048) {
    
    using ElementComputeEpilogue = typename fe527c28457a9b7e570f819855bcf081128b02705::ElementCompute;
    //  TODO: cast to right dtype
    typename fe527c28457a9b7e570f819855bcf081128b02705::Arguments arguments{
    ...
    fe527c28457a9b7e570f819855bcf081128b02705 conv_op;
