...
using fe3d1de61411fd32357272e62acc1ad0278df0a5e = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_h16816fprop_optimized_128x128_32x3_nhwc_single_group_align8_base>;
...
void conv2d_bias_add_relu_6 (
  ...
  *out_ch = CO;
  ...
  if (NI == 1 && HI == 56 && WI == 56 && CI == 64) {
    
    using ElementComputeEpilogue = typename fe3d1de61411fd32357272e62acc1ad0278df0a5e::ElementCompute;
    //  TODO: cast to right dtype
    typename fe3d1de61411fd32357272e62acc1ad0278df0a5e::Arguments arguments{
    ...
    fe3d1de61411fd32357272e62acc1ad0278df0a5e conv_op;
