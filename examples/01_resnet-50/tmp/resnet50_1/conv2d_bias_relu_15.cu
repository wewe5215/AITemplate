...
using fb8fcaf49281502564489dfb341fda4d7d701e36f = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_h16816fprop_optimized_64x64_32x10_nhwc_single_group_align8_base>;
...
void conv2d_bias_relu_15 (
  ...
  *out_ch = CO;
  ...
  if (NI == 1 && HI == 56 && WI == 56 && CI == 128) {
    
    using ElementComputeEpilogue = typename fb8fcaf49281502564489dfb341fda4d7d701e36f::ElementCompute;
    //  TODO: cast to right dtype
    typename fb8fcaf49281502564489dfb341fda4d7d701e36f::Arguments arguments{
    ...
    fb8fcaf49281502564489dfb341fda4d7d701e36f conv_op;
