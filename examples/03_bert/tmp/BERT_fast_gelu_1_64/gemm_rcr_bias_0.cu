...
//  TODO: cast to right dtype
    ...
    if constexpr (cutlass::gemm::detail::IsCutlass3GemmKernel<typename fcef46d1570c8bf61c93f126a41b9d062e8921acd::GemmKernel>::value) {
    arguments = {
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_0 specialization."
  );
}