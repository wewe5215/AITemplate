...
//  TODO: cast to right dtype
    ...
    if constexpr (cutlass::gemm::detail::IsCutlass3GemmKernel<typename fa52ca5b86a2936232e8b42e2d0eda25fb91b621d::GemmKernel>::value) {
    arguments = {
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_add_8 specialization."
  );
}