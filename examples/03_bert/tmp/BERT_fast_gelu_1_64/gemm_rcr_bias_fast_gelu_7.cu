...
//  TODO: cast to right dtype
    ...
    if constexpr (cutlass::gemm::detail::IsCutlass3GemmKernel<typename f5ff1cdd3c2df10b251c88fb1677cffd69a3fbbbd::GemmKernel>::value) {
    arguments = {
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_fast_gelu_7 specialization."
  );
}